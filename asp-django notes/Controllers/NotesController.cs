...
using asp_django_notes.Data;
using asp_django_notes.Models;

namespace asp_django_notes.Controllers
{
    ...
    public class NotesController : ControllerBase
    {
        ...
        // GET: api/Notes
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Notes>>> GetNotes_1()
        {
